...
This sample is meant to accompany the walkthrough at: [Create an Office Add-in that uses Single Sign-on (preview)](https://dev.office.com/docs/add-ins/develop/create-sso-office-add-ins-aspnet.md)
